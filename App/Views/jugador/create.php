    ...
    <body>
        <main>
            ...
            <form method="post" action="<?= $action ?>">
                ...
                <input type="number" id="numero" name="numero" placeholder="Número..." min="1" max="100" step="1" value="<?= $jugador?->numero ?>" />
                ...
                <?php if (!empty($jugador?->equipo_id)): ?> <input type="hidden" value="<?= $jugador?->equipo_id ?>" name="equipo_id" /> <?php endif; ?>
